...
export default function PrivacyPolicy({ onNavigateHome }: PrivacyPolicyProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface flex flex-col pt-24 pb-16 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-[20%] right-[-15%] w-[400px] aspect-square rounded-full bg-primary/5 blur-[100px] pointer-events-none" />
      ...
      <main className="max-w-4xl mx-auto w-full z-10">
        <div className="glass-card border-white/80 rounded-[32px] p-8 md:p-12 shadow-xl text-left">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-outline pb-8 mb-8">
            ...
            <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-cyan/10 text-on-surface-variant text-xs font-mono font-bold shrink-0">
            ...
            <section className="flex flex-col gap-4 border-t border-outline pt-6 mt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono font-bold mt-2">
                <div className="p-4 rounded-xl bg-surface/40 border border-outline">
                  ...
                  <a href="mailto:qdrop5262@gmail.com" className="text-primary text-sm hover:underline mt-1 block font-sans">
                    qdrop5262@gmail.com
                  </a>
                </div>
                <div className="p-4 rounded-xl bg-surface/40 border border-outline">
                  <span className="text-on-surface/40 block text-[9px] uppercase tracking-wider">WHATSAPP DISPATCH</span>
                  <a href="https://wa.me/917001055879" target="_blank" rel="noreferrer" className="text-primary text-sm hover:underline mt-1 block font-sans">
                    +91 70010 55879
                  </a>
                </div>
              </div>
