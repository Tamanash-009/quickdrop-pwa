  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center max-w-lg">
        ...
        <h2 className="font-display font-extrabold text-2xl text-on-surface mb-4">Page Not Found</h2>
        ...
        <button 
          ...
          className="px-6 py-3 rounded-full bg-on-surface text-on-primary font-bold text-sm transition-all hover:scale-105 flex items-center gap-2"
        >
          <Home size={18} />
