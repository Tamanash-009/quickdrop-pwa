...
export default function TermsAndConditions({ onNavigateHome }: TermsAndConditionsProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface flex flex-col pt-24 pb-16 px-6 md:px-12 relative overflow-hidden">
      {/* Ambient background glows */}
      <div className="absolute top-[10%] left-[-15%] w-[500px] aspect-square rounded-full bg-primary/5 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto w-full z-10 mb-8 flex items-center justify-between">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-full border border-outline bg-surface/50 backdrop-blur-md hover:border-brand-primary hover:text-primary transition-all text-xs font-bold uppercase tracking-wider cursor-pointer"
        >
          <ArrowLeft size={14} />
      ...
      <main className="max-w-4xl mx-auto w-full z-10">
        <div className="glass-card border-white/80 rounded-[32px] p-8 md:p-12 shadow-xl text-left">
          {/* Title */}
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-outline pb-8 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="font-display font-extrabold text-3xl md:text-4xl text-on-surface tracking-tight">
                  Terms & Conditions
                </h1>
                <p className="text-xs font-mono font-bold uppercase tracking-wider text-on-surface/40 mt-1">
                  Agreement For Services And Local Deliveries
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary/10 text-on-surface-variant text-xs font-mono font-bold shrink-0">
          ...
          <div className="flex flex-col gap-8">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-sm text-on-surface/75 leading-relaxed">
            ...
            <section className="flex flex-col gap-3">
              ...
              <ul className="list-disc list-inside text-sm text-on-surface-variant space-y-1.5 pl-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <ul className="list-disc list-inside text-sm text-on-surface-variant space-y-1.5 pl-2 mt-2">
            ...
            <section className="flex flex-col gap-4 border-t border-outline pt-6 mt-2">
              <h2 className="font-display font-bold text-lg md:text-xl text-on-surface flex items-center gap-2">
                <span className="w-1.5 h-6 bg-primary rounded-full inline-block" />
                Contact Information
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono font-bold mt-2">
                <div className="p-4 rounded-xl bg-surface/40 border border-outline">
                  <span className="text-on-surface/40 block text-[9px] uppercase tracking-wider">EMAIL DIRECTORY</span>
                  <a href={`mailto:${businessConfig.contact.email}`} className="text-primary text-sm hover:underline mt-1 block font-sans">
                    {businessConfig.contact.email}
                  </a>
                </div>
                <div className="p-4 rounded-xl bg-surface/40 border border-outline">
                  <span className="text-on-surface/40 block text-[9px] uppercase tracking-wider">WHATSAPP DISPATCH</span>
                  <a href={`https://wa.me/${businessConfig.contact.whatsapp}`} target="_blank" rel="noreferrer" className="text-primary text-sm hover:underline mt-1 block font-sans">
