...
export default function Services({ onSelectCategory }: ServicesProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[20%] left-[-10%] w-[400px] aspect-square rounded-full bg-primary/10 blur-[110px]" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 md:gap-3 mb-16 max-w-md mx-auto p-1 bg-surface/50 backdrop-blur-md rounded-full border border-white/60 shadow-sm relative z-20">
                ...
                return (
                  <motion.div
                    ...
                    className={`group rounded-[24px] p-6 md:p-8 transition-all duration-300 relative w-[285px] sm:w-auto shrink-0 sm:shrink ${
                      isComingSoon
                        ? "bg-on-surface/5 opacity-60 border border-outline cursor-not-allowed"
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-300 ${
                        isComingSoon
                          ...
                          : "bg-gradient-to-tr from-brand-primary/10 to-brand-cyan/10 text-primary group-hover:from-brand-primary group-hover:to-brand-cyan group-hover:text-on-primary group-hover:shadow-md"
                      }`}>
                      ...
                      {service.tag && (
                        <span className={`text-[10px] font-mono tracking-widest uppercase font-extrabold px-3 py-1 rounded-full ${
                          service.tag === "Coming Soon"
                            ? "bg-on-surface/15 text-on-surface-variant"
                            : "bg-brand-cyan/10 text-primary border border-brand-cyan/20"
                        }`}>
                          {service.tag}
                        </span>
                      )}
                    ...
                    {!isComingSoon && (
                      <div className="mt-6 flex items-center gap-1.5 text-xs font-bold text-primary uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-[-10px] group-hover:translate-x-0">
